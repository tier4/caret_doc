...
With meta repository and Ansible, you can skip the laborious manual setup which is explained in [tips/manual installation](./manual_installation.md) section (written in Japanese).
