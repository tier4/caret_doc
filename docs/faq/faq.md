...
| ------ | -------------------------------------------------- | ------------------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- |
| 1      | Before the application starts                      | Execute the record command once for any domain (or without specifying a domain) | All domains are subject to measurement.                             | Namespace + Node name is OK if there are no duplicates.</br>Only domains with LD_PRELOAD set can be analyzed. |
